...
import { ArrowLeft, ChevronRight, ShieldCheck, Trash2, Info, Copy, Users } from 'lucide-react';
...
const SettingsView: React.FC<SettingsViewProps> = ({ onBack, user, onSwitchAccount }) => {
  return (
    <div className="min-h-full bg-[#F5F5F4] animate-fade-in font-sans pb-10">
      ...
      <div className="p-4 space-y-4">
         ...
         {/* Group 1: Account & Security (Expanded) */}
